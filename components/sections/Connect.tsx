  ...
  return (
    <div className="flex flex-col items-center mt-10">
      ...
      <div className="flex justify-center gap-8">
        ...
        {/* LinkedIn */}
        <a
          href="https://www.linkedin.com/in/akshay-k-36b17a24b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
          target="_blank"
       ...
       {/* Gmail */}
       <a
  href="https://mail.google.com/mail/?view=cm&fs=1&to=4si21cs021@sit.ac.in.com&su=Want%20to%20connect%20with%20you&body=Hi%20there%2C"
  target="_blank"
  rel="noopener noreferrer"
  className="text-3xl text-[#333] hover:text-[#6cc644] transition-all duration-300"
>
  <MdEmail />
        ...
        {/* GitHub */}
        <a
          href="https://github.com/A-k-S-H-a-Y-K/A-k-S-H-a-Y-K.git"
          target="_blank"
          rel="noopener noreferrer"
          className="text-3xl text-[#333] hover:text-[#6cc644] transition-all duration-300"
        >
